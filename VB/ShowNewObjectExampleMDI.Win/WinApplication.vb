...
Namespace ShowNewObjectExample.Win
	Partial Public Class ShowNewObjectExampleWindowsFormsApplication
		...
		Private Sub ShowNewObjectExampleWindowsFormsApplication_LastLogonParametersRead(ByVal sender As Object, ByVal e As LastLogonParametersReadEventArgs) Handles MyBase.LastLogonParametersRead
